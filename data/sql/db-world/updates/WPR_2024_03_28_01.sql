...
-- 3  Current pet: {petInfo}
-- 4  Rename current pet (15 Gold)
-- 5  Type in your desired pet name in the next popup! Cost: 15 Gold
-- 6  Nevermind...
-- 7  Confirm: Rename pet to '{name}' for 15 Gold?
-- 8  Cancel
-- 9  You don't have enough gold. The rename costs 15 Gold.
-- 10 You must wait a moment before renaming your pet again.
-- 11 Pet type: infernal
-- 12 Pet type: imp
-- 13 Pet type: felhunter
-- 14 Pet type: voidwalker
-- 15 Pet type: succubus
-- 16 Pet type: doomguard
-- 17 Pet type: felguard
-- 18 Pet type: unknown
...
(@MODULE, 4,  'Rename current pet (15 Gold)'),
(@MODULE, 5,  'Type in your desired pet name in the next popup! Cost: 15 Gold'),
(@MODULE, 6,  'Nevermind...'),
(@MODULE, 7,  'Confirm: Rename pet to \'{}\' for 15 Gold?'),
(@MODULE, 8,  'Cancel'),
(@MODULE, 9,  'You don\'t have enough gold. The rename costs 15 Gold.'),
...
(@MODULE, 4,  'koKR', '현재 소환수 이름 변경 (15 골드)'),
(@MODULE, 5,  'koKR', '다음 팝업에서 원하는 소환수 이름을 입력하세요! 비용: 15 골드'),
(@MODULE, 6,  'koKR', '취소...'),
(@MODULE, 7,  'koKR', '확인: 소환수 이름을 \'{}\'(으)로 변경하시겠습니까? 비용: 15 골드?'),
(@MODULE, 8,  'koKR', '취소'),
(@MODULE, 9,  'koKR', '골드가 부족합니다. 이름 변경 비용은 15 골드입니다.'),
...
(@MODULE, 4,  'frFR', 'Renommer le familier actuel (15 Or)'),
(@MODULE, 5,  'frFR', 'Saisissez le nom de familier souhaité dans la fenêtre suivante ! Coût : 15 Or'),
(@MODULE, 6,  'frFR', 'Peu importe...'),
(@MODULE, 7,  'frFR', 'Confirmer : Renommer le familier en \'{}\' pour 15 Or ?'),
(@MODULE, 8,  'frFR', 'Annuler'),
(@MODULE, 9,  'frFR', 'Vous n\'avez pas assez d\'or. Le changement de nom coûte 15 Or.'),
...
(@MODULE, 4,  'deDE', 'Aktuelles Haustier umbenennen (15 Gold)'),
(@MODULE, 5,  'deDE', 'Gebt den gewünschten Haustiernamen im nächsten Popup ein! Kosten: 15 Gold'),
(@MODULE, 6,  'deDE', 'Vergiss es...'),
(@MODULE, 7,  'deDE', 'Bestätigen: Haustier in \'{}\' umbenennen für 15 Gold?'),
(@MODULE, 8,  'deDE', 'Abbrechen'),
(@MODULE, 9,  'deDE', 'Ihr habt nicht genug Gold. Die Umbenennung kostet 15 Gold.'),
...
(@MODULE, 3,  'zhCN', '当前宠物：{}'),
(@MODULE, 4,  'zhCN', '重命名当前宠物（15金币）'),
(@MODULE, 5,  'zhCN', '在下一个弹出窗口中输入你想要的宠物名字！费用：15金币'),
(@MODULE, 6,  'zhCN', '算了...'),
(@MODULE, 7,  'zhCN', '确认：将宠物重命名为'{}'，花费15金币？'),
(@MODULE, 8,  'zhCN', '取消'),
(@MODULE, 9,  'zhCN', '你没有足够的金币。重命名需要15金币。'),
...
(@MODULE, 3,  'zhTW', '當前寵物：{}'),
(@MODULE, 4,  'zhTW', '重新命名當前寵物（15金幣）'),
(@MODULE, 5,  'zhTW', '在下一個彈出視窗中輸入你想要的寵物名字！費用：15金幣'),
(@MODULE, 6,  'zhTW', '算了...'),
(@MODULE, 7,  'zhTW', '確認：將寵物重新命名為'{}'，花費15金幣？'),
(@MODULE, 8,  'zhTW', '取消'),
(@MODULE, 9,  'zhTW', '你沒有足夠的金幣。重新命名需要15金幣。'),
...
(@MODULE, 4,  'esES', 'Renombrar la mascota actual (15 de oro)'),
(@MODULE, 5,  'esES', '¡Escribe el nombre deseado para tu mascota en la siguiente ventana! Coste: 15 de oro'),
(@MODULE, 6,  'esES', 'No importa...'),
(@MODULE, 7,  'esES', 'Confirmar: ¿Renombrar la mascota a \'{}\' por 15 de oro?'),
(@MODULE, 8,  'esES', 'Cancelar'),
(@MODULE, 9,  'esES', 'No tienes suficiente oro. El renombrado cuesta 15 de oro.'),
...
(@MODULE, 4,  'esMX', 'Renombrar la mascota actual (15 de oro)'),
(@MODULE, 5,  'esMX', '¡Escribe el nombre deseado para tu mascota en la siguiente ventana! Coste: 15 de oro'),
(@MODULE, 6,  'esMX', 'No importa...'),
(@MODULE, 7,  'esMX', 'Confirmar: ¿Renombrar la mascota a \'{}\' por 15 de oro?'),
(@MODULE, 8,  'esMX', 'Cancelar'),
(@MODULE, 9,  'esMX', 'No tienes suficiente oro. El renombrado cuesta 15 de oro.'),
...
(@MODULE, 4,  'ruRU', 'Переименовать текущего питомца (15 золота)'),
(@MODULE, 5,  'ruRU', 'Введите желаемое имя питомца в следующем окне! Стоимость: 15 золота'),
(@MODULE, 6,  'ruRU', 'Неважно...'),
(@MODULE, 7,  'ruRU', 'Подтвердить: Переименовать питомца в \'{}\' за 15 золота?'),
(@MODULE, 8,  'ruRU', 'Отмена'),
(@MODULE, 9,  'ruRU', 'У вас недостаточно золота. Переименование стоит 15 золота.'),
